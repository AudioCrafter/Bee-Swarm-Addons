...
namespace Beeswarm_timer_v3
{
...

    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            versionlabel.Text = "Running BSA version v." + this.ProductVersion;
        ...
        private void stopAllTimersToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            tenbeesMemoyMatchTimeDisplay.Text = "Stopped!";
            fivteenbeesMemoyMatchTimeDisplay.Text = "Stopped!";
            thirtyfivebeesMemoyMatchTimeDisplay.Text = "Stopped!";
            nightMemoyMatchTimeDisplay.Text = "Stopped!";
        }
        ...
        private void loop_Tick(object sender, EventArgs e)
        {
            ...
            snowBearAlert = Properties.Settings.Default.SnowbearAlertURL;
        ...
        {
            System.Diagnostics.Process.Start("https://discord.gg/PPRFY5qvFv");
        }
        ...
        private void checkForUpdatesToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            ...
            else if (localversion == gitnewestversion)
            {
                MessageBox.Show("No update avaiable");
            }
            else
            {
