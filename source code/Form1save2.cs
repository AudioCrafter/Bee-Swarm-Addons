...
namespace Beeswarm_timer_v3
{
...

    {
        ...
        string DEBUGTestAlert = "https://otto.mauz.name/nextcloud/s/iBEBGkdmmckNPgd/download/DEBUGTestCountdown%20sound.mp3";
...
;
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (DEBUGSoundDropdown.Text == "NamNamNam")
            {
                axWindowsMediaPlayer1.URL = namnamnamAlert;
            }
            ...
            if (DEBUGSoundDropdown.Text == "Wrath")
            {
                axWindowsMediaPlayer1.URL = festiveWrathAlert;
            }
